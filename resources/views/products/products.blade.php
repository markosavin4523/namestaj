...
@section('content')
    <div class="container pt-2 row m-auto">
        ...
        <aside class="col-12 col-lg-3 p-2">
            <x-products.filter-aside :c="$category" :s="$subcategory" :r="$request"/>
        </aside>
        <div class="col-12 col-md-9 row m-0">
            @if(count($products)==0)
                <div class="mt-2"><p class="alert alert-warning rounded-0">Nema proizvoda izabrane kategorije ili filtera</p></div>
            @else
